...
if (isset($_GET['rickies_event'])) {
	switch ($_GET['rickies_event']) {
		...
		case 'annual':
			...
			break;
		case 'annual-' . $past_x_annual_rickies:
			$pick_filter['filter_other']['rickies_event'] =
				'AND({Rickies type}="annual", {Rickies in past X}<=' . $past_x_annual_rickies . ')';
			break;
		case 'keynote':
			$pick_filter['filter_other']['rickies_event'] = '{Rickies type}="keynote"';
			break;
		case 'keynote-' . $past_x_keynote_rickies:
			$pick_filter['filter_other']['rickies_event'] =
				'AND({Rickies type}="keynote", {Rickies in past X}<=' . $past_x_keynote_rickies . ')';
			break;
		case 'wwdc':
