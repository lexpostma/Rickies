...
<header class="home">
	...
	$trophy_asset
		...
		<div class="hero_heading">
			<?= $hero_title, $hero_tag ?>
			<?php if (date('m') == '9') {
   	echo '<p>🎗️ September is Childhood Cancer Awareness Month.<br/>Let’s come together as the Relay community and <a target="_blank" href="https://relay.experience.stjude.org/" title="Donate to St. Jude" data-goatcounter-referrer="' .
   		current_url() .
   		'">donate to St. Jude</a>.</p>';
   } ?>
		</div>
	</div>
</header>
